      ...
      <v-row class="d-flex align-center justify-center text-left">
        <v-card width="70vw">
          <v-row class="px-10 py-10">
              <v-col cols="12" sm="8" lg="8" class="d-flex justify-center align-center">
                  <v-icon>mdi-lightning-bolt-circle</v-icon>
                  <v-card-text class="letter-spacing-mid"><b>MOIETY</b> UI KIT</v-card-text>
              </v-col>
              <v-col v-if="isMenuBreakdownSize" cols="12" sm="3" lg="3" class="d-flex justify-center align-center text-center flex-wrap">
              ...
              <v-col v-else class="d-flex justify-center align-center pr-3" cols="6" sm="3" md="2" lg="2">
                  <v-menu>
              ...
              <v-col cols="6" sm="1" lg="1" class="d-flex justify-center align-center">
                  <v-btn class="text-none px-6 mx-3" icon="mdi-menu" color="primary"></v-btn>
              </v-col>
          </v-row>
        </v-card>
      </v-row>
...
<script setup lang="ts">
    ...
    const isMenuBreakdownSize = ref(window.innerWidth >= 1150);
    let handleResize = () => {
        isMenuBreakdownSize.value = window.innerWidth >= 1150;
    };
