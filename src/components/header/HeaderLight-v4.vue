      ...
      <v-row class="d-flex align-center justify-center text-left">
        <v-card width="70vw">
          <v-row class="px-10 py-10">
              ...
              <v-col v-if="isMenuBreakdownSize" cols="12" md="8" lg="4" class="d-flex justify-center align-center flex-wrap text-center">
              ...
              <v-col v-else class="d-flex justify-center align-center pr-3" cols="12" sm="4" md="2" lg="2">
                  <v-menu>
              ...
              <v-col cols="12" sm="8" md="4" lg="3" class="d-flex justify-center align-center">
                  <v-btn class="text-none px-8 mx-3" size="large" color="primary">Signup</v-btn>
                  <v-btn class="text-none px-8" size="large" color="primary" variant="outlined">Login</v-btn>
              </v-col>
          </v-row>
        </v-card>
      </v-row>
...
<script setup lang="ts">
    ...
    const isMenuBreakdownSize = ref(window.innerWidth >= 1350);
    let handleResize = () => {
        isMenuBreakdownSize.value = window.innerWidth >= 1350;
    };
